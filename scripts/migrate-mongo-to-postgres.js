    ...
    results.deliveries = await migrateCollection({
      ...
      mapper: (d) => {
        ...
        return {
          ...
          menuFlowSubtotalCents: d.menuFlowSubtotalCents ?? null,
          menuFlowDeliveryFeeCents: d.menuFlowDeliveryFeeCents ?? null,
          menuFlowServiceFeeCents: d.menuFlowServiceFeeCents ?? null,
          menuFlowDiscountCents: d.menuFlowDiscountCents ?? null,
          menuFlowTotalCents: d.menuFlowTotalCents ?? null,
          menuFlowPaymentMethod: d.menuFlowPaymentMethod ?? null,
          menuFlowNeedsChange: d.menuFlowNeedsChange ?? null,
          menuFlowChangeForCents: d.menuFlowChangeForCents ?? null,
          menuFlowExpectedChangeCents: d.menuFlowExpectedChangeCents ?? null,
